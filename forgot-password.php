...
$query=mysqli_query($con,"SELECT * FROM user WHERE email='$email' and contactno='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
//$extra="forgot-password.php";
mysqli_query($con,"update user set password='$password' WHERE email='$email' and contactno='$contact' ");
