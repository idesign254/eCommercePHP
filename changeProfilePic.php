<?php
	...
	if(strlen($_SESSION['login'])==0) { 
		echo "<script> window.location.assign('profilelogin.php'); </script>";
			...
			move_uploaded_file($_FILES["profile"]["tmp_name"],"images/profile_pics/".$_FILES["profile"]["name"]);
		...
		<?php include('include/sidebar.php');?>				
			...
			<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<div class="controls">
							<p><?php echo htmlentities($rowuser['email']);?></p>
						</div>
					</div>

					<div class="control-group">
						<label class="control-label" for="basicinput">Current Profile</label>
						<div class="controls">
						<img src=<?php echo $ProfileimagePath.$rowuser['Profile']; ?> width="200">
						</div>
					</div>

					<div class="control-group">
					<label class="control-label" for="basicinput">Upload New Image</label>
					<div class="controls">
