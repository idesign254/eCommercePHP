...
$query=mysqli_query($con,"insert into user(firstname,lastname,username,contactno,email,address,password,Profile) 
	values('$firstname','$lastname','$username','$contactno','$email','$address','$password','$profile')");
if($query)
	{
	echo "<script>alert('successfully registered, Proceed to signIn');</script>";
	}
else{
 	...
 	<form  method="post" style="padding-bottom: 50px;padding-top: 50px;padding-left: 20px">
		...
		<div >
		  	...
		  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="login">Login</button>
   			 ...
   			 <div class="col-sm-6" >
	<form  role="form" method="post" name="register" enctype="multipart/form-data" onSubmit="return valid();" style="padding-bottom: 50px;padding-top: 50px;padding-right: 20px">
...
<div class="controls">
<input type="file" name="profile" id="profile" value="" class="span8 tip" required>
</div>
</div><br>
