...
$query=mysqli_query($con,"select pName,productImage1 from products where id='$pid'");
$cnt=1;
...
<div class="controls">
<img src="images/sales/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> 
</div>
</div>
